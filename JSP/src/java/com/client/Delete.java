...
public class Delete extends HttpServlet {
    ...
    private String deleteProduct(java.lang.String idUser, java.lang.String idProduk) throws ClassNotFoundException_Exception, SQLException_Exception {
        // Note that the injected javax.xml.ws.Service reference as well as port objects are not thread safe.
        // If the calling of port operations may lead to race condition some synchronization is required.
        manasik.marketplace.YourProductWS port = service.getYourProductWSPort();
        return port.deleteProduct(idUser, idProduk);
    }
