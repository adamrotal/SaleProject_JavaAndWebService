...
public class Catalog_produk {
    ...
    public Catalog_produk(int id, int idP, String name, String desc, int harga, String gbr, Date tanggalTambah, String namaP, int del) {
        this.id = id;
        idPenjual = idP;
        this.name = name;
        description = desc;
